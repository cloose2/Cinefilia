...
import {interesse,vistos,deletarInteresse} from '../actions/Filmes';
...
class detalhesFilmes extends Component{
    ...
    _deletar(id){
        this.props.deletarInteresse(id);
    }
...
export default connect(mapStateToProps,{interesse,vistos,deletarInteresse})(detalhesFilmes);
